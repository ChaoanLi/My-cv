...
\resumeSubheading
{University of Science and Technology Beijing (USTB)}{Beijing, People’s Republic of China}
{Second Major - Financial Engineering;  GPA: 3.89/4;}{Sep. 2018 -- Jul. 2021}
...
\begin{itemize}
    ...
    inequalities}, Acta Math. Appl. Sin. Engl. Ser, (2024), https://doi.org/10.1007/s10255-024-1124-5.
\end{itemize}
\vspace{2pt}
%-----------Awards-----------------
...
\begin{description}[font=$\bullet$]
    \item   \textbf{Programming:}\;{Proficient in Matlab, R, Python
     and \LaTeX. Familiar with C\# and SQL.}
    \vspace{2pt}
